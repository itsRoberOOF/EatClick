...
Hamburguesas = {
    "Tradicional": [3.99, "Hamburguesa tradicional con tocino y carne de res a la parrilla", "tradicional.jpg", "Hamburguesas"],
    "Hamburguesa de pavo": [4.99, "Hamburguesa de pavo baja en grasas saturadas y calorías", "depavo.jpg", "Hamburguesas"],
    "BBQ": [5.99, "Hamburguesa de carne de res con salsa BBQ dulce y ahumada encima", "bbq.jpg", "Hamburguesas"]
}

Bebidas = {
    "Agua": [0.99, "Una botella de agua de 1 litro", "agua.jpg", "Bebidas"],
    "Soda": [1.50, "Una lata de soda del sabor de tu preferencia", "sodas.jpg", "Bebidas"],
    "Licuados": [2.50, "Licuado de guineo, fresa, papaya, guineo con fresa o de galleta", "licuados.jpg", "Bebidas"]
}

Entradas = {
    "Alitas": [4.99, "Una orden de 10 alitas", "alitas.jpg", "Entradas"],
    "Nachos": [4.99, "Una orden de nachos con chili, guacamole y queso", "nachos.jpg", "Entradas"],
    "Pan con ajo": [3.99, "Una orden de 10 rebanadas de pan con ajo", "pan.jpeg", "Entradas"]
}
